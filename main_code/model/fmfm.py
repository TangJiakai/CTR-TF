...
from main_code.layer import PredictLayer, Linear, FmFMLayer
from copy import copy


def FmFM(feat_columns, task, linear_l2_reg=0.0, emb_l2_reg=0.0, prefix='FwFM'):
    ...
    fmfm_emb_list, fmfm_dense_list = get_input_from_feat_columns(input_feats, feat_columns, emb_l2_reg, prefix=prefix)
    fwfm_logit = FmFMLayer()(fmfm_emb_list)
