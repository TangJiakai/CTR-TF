...
from main_code.layer import Linear, DNN, DCNCrossNet, PredictLayer
from main_code.inputs import build_input_feats, get_input_from_feat_columns
from main_code.feature import SparseFeat
from copy import copy


def DCN(linear_feat_columns, dnn_feat_columns, cross_num, linear_l2_reg=0., emb_l2_reg=0., dcn_l2_reg=0., dnn_hidden_units=(64,32),
    ...
    cross_output = DCNCrossNet(cross_num, dcn_l2_reg)(dnn_input)
    ...
    cross_and_dnn_logit = Linear(False, dcn_l2_reg)(cross_and_dnn_output)
